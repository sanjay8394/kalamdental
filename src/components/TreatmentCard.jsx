...
export default function TreatmentCard({ treatment, onSelectTreatment }) {
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-card border border-medical-teal/10 hover:shadow-elevated transition-all duration-300 flex flex-col group h-full">
      {/* Image Header */}
      <div className="relative h-48 sm:h-52 overflow-hidden bg-mint-mist">
        ...
        {treatment.popular && (
          <div className="absolute top-3 right-3">
            <span className="bg-soft-coral text-white text-[11px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full shadow-md">
              ★ Popular
            </span>
          </div>
        )}
      ...
      <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
        <div>
          <h3 className="text-xl font-extrabold text-deep-teal group-hover:text-medical-teal transition-colors mb-2">
            {treatment.title}
          </h3>
        ...
        <div className="pt-2 border-t border-gray-100 flex items-center gap-2">
          ...
          <a
            ...
            className="px-3 py-2 rounded-xl bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white transition-colors text-xs font-semibold flex items-center gap-1.5"
